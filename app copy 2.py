...
from next_gamejs import celuloza19ng, celulozajmng, celulozatrng, today
...
def home():
    ...
    if result is None:
        ...
        return render_template('news.html', articles=articles, js=js, jm=jm, trng=trng, next_gamejm=next_gamejm, celuloza19ng=celuloza19ng, sen=sen, next_game=next_game, next_gametr=next_gametr)
